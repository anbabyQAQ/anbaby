...
#import "PutJsonHttpThread.h"

@implementation PutJsonHttpThread
...
-(void)http{
    ...
    self.task = [sessionManager PUT:self.url parameters:self.params success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
