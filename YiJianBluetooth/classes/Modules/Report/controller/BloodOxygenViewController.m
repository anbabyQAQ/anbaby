...
@interface BloodOxygenViewController ()<ChartViewDelegate,DOPDropDownMenuDataSource,DOPDropDownMenuDelegate>{
...
- (void)setHeartchart{
    ...
    leftAxis.valueFormatter.positiveSuffix = @" bpm";//数字后缀单位
...
- (void)addScrollview{
    ...
    _pieChart1 = [[PieChart alloc] initWithFrame:CGRectMake(20, 300*1, SCR_W-40, 300)];
    _pieChart2 = [[PieChart alloc] initWithFrame:CGRectMake(20, 300*2, SCR_W-40, 300)];
    _pieChart3 = [[PieChart alloc] initWithFrame:CGRectMake(20, 300*3, SCR_W-40, 300)];
    _pieChart4 = [[PieChart alloc] initWithFrame:CGRectMake(20, 300*4, SCR_W-40, 300)];
    ...
    float bottom = 20.0;
    _scrollView.contentSize = CGSizeMake(self.scrollView.frame.size.width, 300*5+bottom+NAVIGATION_HEIGHT);
